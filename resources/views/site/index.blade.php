<x-site-layout>
    ...
    {{-- About me --}}
     <section class="w-full mx-auto bg-gray-900">
        <section id="about" class="max-w-md lg:max-w-6xl mx-auto mt-32">
            ...
            <div class="px-5">
                <h1 class="text-4xl lg:text-5xl font-black capitalize tracking-wider leading-relaxed mt-3 text-gray-300">About <span class="text-4xl">me<span></h1>
                <p class="text-base md:text-lg font-semibold mt-5 text-gray-500">I am Professional Web Designer and Developer. I build backend services (APIs) with a focus on high availability, a low latency, and scalability. My core language is PHP-Laravel.</p>
                 ...
                 <a href="/contact">
                    <p class="text-base md:text-lg hover:text-gray-300 text-red-400 font-semibold mt-5 border-b-2 border-red-400">
                        Hire me! --->
                    </p>
                </a>
            </div>
	...
	<div class="splide__track">
		<ul class="splide__list">
            ...
            <li class="splide__slide">
                <div class="max-w-md mx-auto py-10 px-8 shadow-lg rounded-lg mt-24 bg-gray-900">
                <h2 class="text-gray-300 text-2xl mt-2 md:mt-0 md:text-3xl font-semibold">{{$service->title}}</h2>
    ...
    <section class="max-w-md lg:max-w-5xl mx-auto mt-36">
        <div class="flex justify-between">
            <div>
                <p class="text-3xl tracking-wide font-semibold leading-relaxed"><span class="text-5xl">Projects</span> I've build and</p>
    ...
    @foreach($projects as $project)
        <section>
            <article class="lg:py-4 lg:flex lg:justify-center mt-8">
                <div class="bg-white lg:mx-8 lg:flex max-w-md mx-auto lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
                    <div class="lg:w-1/2">
                        <div class="h-64 bg-cover bg-center lg:h-full" style="background-image:url('{{$project->image_link}}')"></div>
                    </div>
        
                    <div class="py-12 px-10 max-w-xl lg:max-w-5xl lg:w-1/2 bg-gray-200">
