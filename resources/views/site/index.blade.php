<x-site-layout>
    <x-site.header/>
    {{-- hero --}}
    <section class="max-w-md lg:max-w-6xl mx-auto mt-20">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
         <div class="flex md:order-last justify-center py-5">
    ...
    <div class="splide max-w-6xl mx-auto">
	<div class="splide__track">
		<ul class="splide__list">
			<li class="splide__slide">
                <div class="max-w-md mx-auto py-4 px-8 shadow-lg rounded-lg mt-24 bg-gray-100 py-10">
                <h2 class="text-gray-800 text-2xl mt-2 md:mt-0 md:text-3xl font-semibold">Web Design</h2>
        
                <p class="mt-2 text-gray-500 font-semibold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores deserunt ea doloremque natus error, rerum quas odio quaerat nam ex commodi hic, suscipit in a veritatis pariatur minus consequuntur!</p>
                </div>
            </li>
			<li class="splide__slide"> 
                <div class="max-w-md mx-auto py-4 px-8 shadow-lg rounded-lg mt-24 bg-gray-100 py-10">
                <h2 class="text-gray-800 text-2xl mt-2 md:mt-0 md:text-3xl font-semibold">Web Development</h2>
			...
			<li class="splide__slide"> 
                <div class="max-w-md mx-auto py-4 px-8 shadow-lg rounded-lg mt-24 bg-gray-100 py-10">
                <h2 class="text-gray-800 text-2xl mt-2 md:mt-0 md:text-3xl font-semibold">M-Pesa Intergration</h2>
    ...
    {{-- work --}}
    <section class="lg:py-12 lg:flex lg:justify-center mt-8">
        <div class="bg-white lg:mx-8 lg:flex max-w-md mx-auto lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
            <div class="lg:w-1/2">
                <div class="h-64 bg-cover bg-center lg:h-full" style="background-image:url('https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80')"></div>
            </div>

            <div class="py-12 px-10 max-w-xl lg:max-w-5xl lg:w-1/2">
                <h2 class="text-2xl text-gray-800 font-bold md:text-3xl">Build Your New <span class="text-red-400">Idea</span></h2>
                <p class="mt-4 text-gray-500 font-semibold">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quidem modi reprehenderit vitae exercitationem aliquid dolores ullam temporibus enim expedita aperiam mollitia iure consectetur dicta tenetur, porro consequuntur saepe accusantium consequatur.</p>
                
                <div class="mt-8">
                    <a href="#" class="border-2 border-gray-800 text-gray-800 px-5 py-3 font-semibold rounded hover:text-gray-300 hover:bg-gray-800">Visit Site</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="lg:flex max-w-6xl mx-auto space-x-4">
        <div class="max-w-md mx-auto py-4 px-8 shadow-lg rounded-lg mt-24 bg-gray-100">
            <div class="flex justify-center md:justify-end -mt-10">
                <img class="w-20 h-20 object-cover rounded-full border-2 border-gray-500" alt="Testimonial avatar" src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=76&q=80">
            </div>
            ...
            <div class="flex justify-end mt-4">
                <a href="#" class="text-xl font-semibold text-gray-800">John Doe</a>
            </div>
        </div>
        <div class="max-w-md mx-auto py-4 px-8 shadow-lg rounded-lg mt-24 bg-gray-100">
            <div class="flex justify-center md:justify-end -mt-10">
