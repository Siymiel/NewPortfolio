    ...
    <div class="flex bg-gray-100">
        <x-dashboard.aside/>
            <div class="flex flex-col flex-1 w-full">
                <x-dashboard.header/>
        <a class="mt-10 lg:ml-24 lg:mr-24" href="{{route('dashboard.projects.index')}}">
        ...
        <main class="h-full overflow-y-auto">
            <h1 class="font-semibold text-lg ml-12 lg:ml-24 mb-6 mt-6 ">Add New Project</h1>
                ...
                <div class="max-w-sm lg:max-w-4xl mx-auto mb-20">
                    ...
                    <div class="mt-8">
                        ...
                        <x-label for="body">
                            ...
                            <div>
                                <textarea id="body" rows="10" name="body" class="tiny-editor @error('body') border-red-500 @enderror form-textarea block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{old('description')}}</textarea>
                            </div>
                        </x-label>
                    </div>
