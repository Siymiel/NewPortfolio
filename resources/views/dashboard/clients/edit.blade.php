<x-dashboard-layout>
    <div class="flex bg-gray-100">
        ...
        <main class="h-full overflow-y-auto">
            <h1 class="font-semibold text-lg ml-12 lg:ml-24 mb-6 mt-6 ">Edit Client</h1>
                ...
                <div class="max-w-sm lg:max-w-4xl mx-auto mb-20">
                    ...
                    <div class="mt-8">
                        ...
                        <x-label for="body">
                            ...
                            <div>
                                <textarea id="body" rows="10" name="body" class="tiny-editor @error('body') border-red-500 @enderror form-textarea block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{old('body', $client->body)}}</textarea>
                            </div>
                        </x-label>
                    </div>
                    ...
                    <div class="mt-8">
                        <x-label for="image">
                            ...
                            {{-- View current Client image --}}
                            @if ($img_link = $client->image_link)
                                <div class="mt-3">
                    ...
                    <div class="mt-8">
                        <p class="text-sm leading-5 text-blueGray-300 font-semibold">Mark Client as Approved</p>
                            <div class="mt-4 flex items-center">
                                <input id="active" name="active" type="radio" value="1" {{old('active', $client->active) ? 'checked="checked"' : ''}} class=" @error('active') border-red-500 @enderror form-radio h-4 w-4 text-green-500 transition duration-150 ease-in-out">
                                <label for="active" class="ml-3">
                                    <span class="block text-sm leading-5 font-medium text-gray-700">Approved</span>
                                </label>
                            </div>
                            <div class="mt-4 flex items-center">
                                <input id="not_active" name="active" type="radio" value="0" {{old('active', $client->active) ?  : 'checked="checked"'}} class=" @error('active') border-red-500 @enderror form-radio h-4 w-4 text-red-500 transition duration-150 ease-in-out">
